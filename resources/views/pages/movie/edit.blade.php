...
@section('content')
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label for="name" class="col-sm-3 col-form-label">{{ __('Genre') }}<sup>*</sup></label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control form-datepicker" name="release_date" id="release_date" value="{{ $data->release_date ? $data->release_date->format('d/m/Y') : ''  }}">
                </div>
            </div>
        </div>
    </div>
