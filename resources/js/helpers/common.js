(function($) {
    window.myCommon = {
        // return {
            ...
            //REMOTE MODAL
            initModalAjax: function (selector) {
            ...
            // DATA TABLES
            initDatatableAction: function (table_id, callback) {
            ...
            initDatatableTools: function (table_id, oTable) {
                ...
                $('.btn-delete-selected', table_id).click(function() {
                    ...
                    if (id.length > 0) {
                        ...
                        command: toastr["warning"]("Data not found");
                    }
            ...
            dd_cascade: function (target, url, data, selected) {
            ...
            generate_code: function (selector, url) {
                var target = $(selector);
